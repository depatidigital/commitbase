...
export const DATABASE_KEYS = new Set([
  ...
  // the postgres image's names, which compose stacks pass on (CKAN: POSTGRES_HOST, _PORT, _PASSWORD)
  "POSTGRES_HOST", "POSTGRES_PORT", "POSTGRES_DB", "POSTGRES_DATABASE", "POSTGRES_USER", "POSTGRES_USERNAME", "POSTGRES_PASSWORD",
]);
