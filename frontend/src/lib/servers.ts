...
export const SYSTEM_TARGETS = ['journal', 'rotatedLogs', 'bigLogs', 'pm2Logs', 'aptCache', 'aptAutoremove', 'oldSnaps', 'snapCache', 'packageCaches', 'buildCaches', 'docker', 'podman', 'podmanVolumes', 'crashDumps', 'oldTmp', 'trash'] as const;
