...
export const SYSTEM_TARGETS = ['journal', 'rotatedLogs', 'bigLogs', 'pm2Logs', 'aptCache', 'aptAutoremove', 'oldSnaps', 'packageCaches', 'docker', 'podman', 'podmanVolumes', 'crashDumps', 'oldTmp'] as const;
