...
export default {
  ...
  "Troubleshoot": "Perbaikan",
  "Fix without redeploying": "Perbaiki tanpa deploy ulang",
  ...
  "Every hostname points at the server, behind the Cloudflare proxy.": "Semua hostname mengarah ke server, di balik proxy Cloudflare.",
