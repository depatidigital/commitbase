...
export default {
  ...
  "Tip: paste a whole .env file into any name field.": "Tip: tempel seluruh isi file .env ke kolom nama mana pun.",
  "from {file}": "dari {file}",
  ...
  "DATABASE_URL is set.": "DATABASE_URL sudah diatur.",
  "No database connected yet.": "Belum ada database yang terhubung.",
  ...
  "Environment variable": "Variabel environment",
